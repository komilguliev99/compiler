...
void* findOriginalIC(vector<vector<void*>*>* pattern, void* LocTable, void* uK); //Найти адрес ИК исходного графа по таблице соответствий
...
void ProgExec(vector<ip> *Uk, FU* Bus, vector<ip>::iterator *Start=nullptr); // Исполнение программы из ИК
